...
def get_domain():
    ...
    sql = 'SELECT domain FROM whois_info_copy_copy where (reg_name=" " and reg_email=" " and reg_phone=" ") limit 500 '
    cursor.execute(sql)
...
def main():
    ...
    while count * THREADNUM < total_domain_count:
        ...
        jobs = [gevent.spawn(check_domain,domain.strip()) for domain in domains]
